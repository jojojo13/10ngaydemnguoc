...
export class RequestService {
  baseUrl = 'http://139.99.90.39:3100/api/RequestAPI';
  selectedRequest = {
    code: '',
    comment: 'string',
    createdOn: '',
  ...
  getAutoGenerateCODE(
    ...
    return this.__http.post(
      'http://139.99.90.39:3100/api/CommonAPI/autoGenCode',
  ...
  insertRequest(request: any) {
    ...
    return this.__http.post(
      'http://139.99.90.39:3100/api/RequestAPI/InsertRequest',
  ...
  editRequest(request: any) {
    ...
    return this.__http.put('http://139.99.90.39:3100/api/RequestAPI/ModifyRequest', request, httpOptions1);
  }
  ...
  sendComment(request: any) {
    ...
    return this.__http.put('http://139.99.90.39:3100/api/RequestAPI/SendComment', request, httpOptions1);
  }
  ...
  setHRID(id: number, hrID: number) {
    ...
    return this.__http.put('http://139.99.90.39:3100/api/RequestAPI/setHrInchage', { id, hrID }, httpOptions1)
  }

  getRequestByID(id: number) {
    return this.__http.put(`http://139.99.90.39:3100/api/RequestAPI/GetRequestByID?Id=${id}`, {});
  }
  modifyRQbyID(id: number, comment: string) {
    return this.__http.put(`http://139.99.90.39:3100/api/RequestAPI/SendComment`, { id, comment });
  }
